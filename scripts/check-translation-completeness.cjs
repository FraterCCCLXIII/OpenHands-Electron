...
const IDENTICAL_VALUE_ALLOWLIST = new Set([
  ...
  'COMMAND_MENU$WORKFLOWS_KEYWORDS',
  'WORKFLOWS$COLUMN_AUTOMATION_COUNT',
  'WORKFLOWS$SOURCE_GITHUB',
  'WORKFLOWS$SOURCE_JIRA',
  'WORKFLOWS$SOURCE_LINEAR',
  'WORKFLOWS$STAGE_AUTOMATION_COUNT',
]);
