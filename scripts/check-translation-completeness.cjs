...
const IDENTICAL_VALUE_ALLOWLIST = new Set([
  ...
  // English prompt bodies for chat suggestion chips — agent instructions, not UI copy
  'AUTOMATIONS$STARTER_STANDUP_DIGEST_PROMPT',
  'AUTOMATIONS$STARTER_SHIP_REPORT_PROMPT',
  'AUTOMATIONS$STARTER_CI_WATCHDOG_PROMPT',
  'HOME$SUGGESTION_DEPENDENCY_AUDIT_PROMPT',
  'HOME$SUGGESTION_PR_REVIEW_DIGEST_PROMPT',
  'HOME$SUGGESTION_RELEASE_NOTES_PROMPT',
  'HOME$SUGGESTION_FLAKY_TEST_DIGEST_PROMPT',
  'HOME$SUGGESTION_ISSUE_TRIAGE_PROMPT',
  'HOME$SUGGESTION_STALE_BRANCH_CLEANUP_PROMPT',
  'BACKEND$CLOUD_TITLE',
